import { AlertTriangle, Database, FileText, BookOpen } from 'lucide-react';
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";
import TestCard from '../components/TestCard';
import { SanityContentExplorer } from '@/components/admin/SanityContentExplorer';

// This is a server component - get environment variables directly
...
export default async function SanityTestPage() {
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold mb-6">Sanity CMS Tests</h2>
      ...
      <Tabs defaultValue="guide">
        ...
        <TabsContent value="guide">
          <TestCard 
            title="Sanity CMS Testing Guide" 
            description="How to use these tools effectively"
            icon={BookOpen}
          >
        ...
        <TabsContent value="connection">
          <TestCard 
            ...
            description="Information about current Sanity environment setup"
            icon={FileText}
          >
        ...
        <TabsContent value="content">
          <TestCard 
            ...
            description="Browse and inspect Sanity content by type"
            icon={FileText}
          >
            <SanityContentExplorer config={config} />
          </TestCard>
        </TabsContent>
      </Tabs>
    </div>
