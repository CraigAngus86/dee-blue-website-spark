          ...
          <div className="text-right">
            <div className="flex space-x-3 justify-end">
              <a 
                ...
                className={`${result.match_report_link ? 'text-[#00105A] hover:text-[#FFD700]' : 'text-gray-300 cursor-default'} transition-colors`}
                title="Match Report"
              ...
              <a 
                ...
                className={`${result.gallery_link ? 'text-[#00105A] hover:text-[#FFD700]' : 'text-gray-300 cursor-default'} transition-colors`}
                title="Photo Gallery"
                onClick={e => !result.gallery_link && e.preventDefault()}
              >
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
